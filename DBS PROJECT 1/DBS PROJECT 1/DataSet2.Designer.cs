...
namespace DBS_PROJECT_1 {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class CARDataTable : global::System.Data.TypedTableBase<CARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CARRow AddCARRow(string REGNO, string MODEL, string COLOR, string TYPE, string RENTPERDAY, string AVAILABILITY) {
...
namespace DBS_PROJECT_1.DataSet2TableAdapters {
    ...
    public partial class CARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"SYS\".\"CAR\" (\"REGNO\", \"MODEL\", \"COLOR\", \"TYPE\", \"RENTPERDAY\", \"AVAILA" +
                "BILITY\") VALUES (:REGNO, :MODEL, :COLOR, :TYPE, :RENTPERDAY, :AVAILABILITY)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""SYS"".""CAR"" SET ""REGNO"" = :REGNO, ""MODEL"" = :MODEL, ""COLOR"" = :COLOR, ""TYPE"" = :TYPE, ""RENTPERDAY"" = :RENTPERDAY, ""AVAILABILITY"" = :AVAILABILITY WHERE ((""REGNO"" = :Original_REGNO) AND ((:IsNull_MODEL = 1 AND ""MODEL"" IS NULL) OR (""MODEL"" = :Original_MODEL)) AND ((:IsNull_COLOR = 1 AND ""COLOR"" IS NULL) OR (""COLOR"" = :Original_COLOR)) AND ((:IsNull_TYPE = 1 AND ""TYPE"" IS NULL) OR (""TYPE"" = :Original_TYPE)) AND ((:IsNull_RENTPERDAY = 1 AND ""RENTPERDAY"" IS NULL) OR (""RENTPERDAY"" = :Original_RENTPERDAY)) AND ((:IsNull_AVAILABILITY = 1 AND ""AVAILABILITY"" IS NULL) OR (""AVAILABILITY"" = :Original_AVAILABILITY)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT REGNO, MODEL, COLOR, \"TYPE\", RENTPERDAY, AVAILABILITY FROM SYS.CAR";
        ...
        public virtual int Delete(string Original_REGNO, string Original_MODEL, string Original_COLOR, string Original_TYPE, string Original_RENTPERDAY, string Original_AVAILABILITY) {
        ...
        public virtual int Insert(string REGNO, string MODEL, string COLOR, string TYPE, string RENTPERDAY, string AVAILABILITY) {
            if ((REGNO == null)) {
        ...
        public virtual int Update(string REGNO, string MODEL, string COLOR, string TYPE, string RENTPERDAY, string AVAILABILITY, string Original_REGNO, string Original_MODEL, string Original_COLOR, string Original_TYPE, string Original_RENTPERDAY, string Original_AVAILABILITY) {
            if ((REGNO == null)) {
                throw new global::System.ArgumentNullException("REGNO");
            }
            else {
            ...
            if ((Original_RENTPERDAY == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_RENTPERDAY));
            }
            if ((Original_AVAILABILITY == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MODEL, string COLOR, string TYPE, string RENTPERDAY, string AVAILABILITY, string Original_REGNO, string Original_MODEL, string Original_COLOR, string Original_TYPE, string Original_RENTPERDAY, string Original_AVAILABILITY) {
            return this.Update(Original_REGNO, MODEL, COLOR, TYPE, RENTPERDAY, AVAILABILITY, Original_REGNO, Original_MODEL, Original_COLOR, Original_TYPE, Original_RENTPERDAY, Original_AVAILABILITY);
        }
    }
